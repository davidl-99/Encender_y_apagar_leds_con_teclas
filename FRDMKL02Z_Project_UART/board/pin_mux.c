...
- pin_list:
  - {pin_num: '17', peripheral: UART0, signal: TX, pin_signal: ADC0_SE5/CMP0_IN3/PTB1/IRQ_6/UART0_TX/UART0_RX, slew_rate: slow, open_drain: disable, drive_strength: low,
...
void BOARD_InitPins(void)
{
    ...
    PORT_SetPinConfig(BOARD_INITPINS_DEBUG_UART0_TX_PORT, BOARD_INITPINS_DEBUG_UART0_TX_PIN, &DEBUG_UART0_TX);
